...
import com.karthiknaik.easyshare.BuildConfig;
import com.karthiknaik.easyshare.fragment.HomeFragment;
    ...
    private void applyAwaitingDrawerAction()
    {
        if (mChosenMenuItemId == 0) {
         ...
         //   finish();
            ...
            String shareBody = "EasyShare app download now. https://play.google.com/store/apps/details?id=" + getApplicationContext().getPackageName();
            ...
            wv.loadUrl("https://www.karthiknaik12.blogspot.com"); //Your Privacy Policy Url Here
            ...
            Uri uri = Uri.parse("market://search?q=pub:" + "Karthik Mittu"); //Developer AC Name
            Intent goToMarket = new Intent(Intent.ACTION_VIEW, uri);
            try {
                startActivity(goToMarket);
            } catch (ActivityNotFoundException e) {
                startActivity(new Intent(Intent.ACTION_VIEW,
                        Uri.parse("http://play.google.com/store/search?q=pub:" + "Karthik Mittu"))); //Developer AC Name
            }
        }
