...
import com.karthiknaik.easyshare.base.Keyword;
import com.karthiknaik.easyshare.db.AccessDatabase;
import com.karthiknaik.easyshare.fragment.FileListFragment;
import com.karthiknaik.easyshare.util.AppUtils;
import com.karthiknaik.easyshare.util.CommunicationBridge;
import com.karthiknaik.easyshare.util.CommunicationNotificationHelper;
import com.karthiknaik.easyshare.util.DynamicNotification;
import com.karthiknaik.easyshare.util.FileUtils;
import com.karthiknaik.easyshare.util.HotspotUtils;
...
import com.karthiknaik.easyshare.util.NsdDiscovery;
...
import com.karthiknaik.easyshare.model.TextStreamObject;
import com.karthiknaik.easyshare.model.TransferGroup;
import com.karthiknaik.easyshare.model.TransferInstance;
import com.karthiknaik.easyshare.model.TransferObject;
...
public class CommunicationService extends Service
{
    ...
    public static final String ACTION_FILE_TRANSFER = "com.karthiknaik.easyshare.action.FILE_TRANSFER";
    public static final String ACTION_CLIPBOARD = "com.karthiknaik.easyshare.action.CLIPBOARD";
    public static final String ACTION_CANCEL_INDEXING = "com.karthiknaik.easyshare.action.CANCEL_INDEXING";
    public static final String ACTION_IP = "com.karthiknaik.easyshare.action.IP";
    public static final String ACTION_END_SESSION = "com.karthiknaik.easyshare.action.END_SESSION";
    public static final String ACTION_SEAMLESS_RECEIVE = "com.genonbeta.intent.action.SEAMLESS_START";
    public static final String ACTION_CANCEL_JOB = "com.karthiknaik.easyshare.transaction.action.CANCEL_JOB";
    public static final String ACTION_TOGGLE_SEAMLESS_MODE = "com.karthiknaik.easyshare.transaction.action.TOGGLE_SEAMLESS_MODE";
    public static final String ACTION_REVOKE_ACCESS_PIN = "com.karthiknaik.easyshare.transaction.action.REVOKE_ACCESS_PIN";
    public static final String ACTION_TOGGLE_HOTSPOT = "com.karthiknaik.easyshare.transaction.action.TOGGLE_HOTSPOT";
    public static final String ACTION_REQUEST_HOTSPOT_STATUS = "com.karthiknaik.easyshare.transaction.action.REQUEST_HOTSPOT_STATUS";
    public static final String ACTION_HOTSPOT_STATUS = "com.karthiknaik.easyshare.transaction.action.HOTSPOT_STATUS";
    public static final String ACTION_DEVICE_ACQUAINTANCE = "com.karthiknaik.easyshare.transaction.action.DEVICE_ACQUAINTANCE";
    public static final String ACTION_SERVICE_STATUS = "com.karthiknaik.easyshare.transaction.action.SERVICE_STATUS";
    public static final String ACTION_SERVICE_CONNECTION_TRANSFER_QUEUE = "com.karthiknaik.easyshare.transaction.action.SERVICE_CONNECTION_TRANSFER_QUEUE";
    public static final String ACTION_TASK_STATUS_CHANGE = "com.karthiknaik.easyshare.transaction.action.TASK_STATUS_CHANGE";
    public static final String ACTION_TASK_RUNNING_LIST_CHANGE = "com.karthiknaik.easyshare.transaction.action.TASK_RUNNNIG_LIST_CHANGE";
    public static final String ACTION_REQUEST_TASK_STATUS_CHANGE = "com.karthiknaik.easyshare.transaction.action.REQUEST_TASK_STATUS_CHANGE";
    public static final String ACTION_REQUEST_TASK_RUNNING_LIST_CHANGE = "com.karthiknaik.easyshare.transaction.action.REQUEST_TASK_RUNNING_LIST_CHANGE";
    public static final String ACTION_INCOMING_TRANSFER_READY = "com.karthiknaik.easyshare.transaction.action.INCOMING_TRANSFER_READY";
    public static final String ACTION_TRUSTZONE_STATUS = "com.karthiknaik.easyshare.transaction.action.TRUSTZONE_STATUS";
    public static final String ACTION_REQUEST_TRUSTZONE_STATUS = "com.karthiknaik.easyshare.transaction.action.REQUEST_TRUSTZONE_STATUS";
    public static final String ACTION_TOGGLE_WEBSHARE = "com.karthiknaik.easyshare.transaction.action.TOGGLE_WEBSHARE";
    public static final String ACTION_WEBSHARE_STATUS = "com.karthiknaik.easyshare.transaction.action.WEBSHARE_STATUS";
    public static final String ACTION_REQUEST_WEBSHARE_STATUS = "com.karthiknaik.easyshare.transaction.action.REQUEST_WEBSHARE_STATUS";
